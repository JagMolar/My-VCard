...
<html class="no-js" lang="en">
    <head> 
        ...
        <meta name="description" content="MyVCard | Design and create your personal Virtual Card. Login">
                ...
                <div class="row flex-row h-100">
                    <div class="col-xl-4 col-lg-4 col-md-4 m-auto">
                        <div class="authentication-form mx-auto">
                            ...
                            <div class="register">
                                <p>{{ __('No account?')}} <a href="{{url('register/new-register')}}">{{ __('Sign Up')}}</a></p>
                            </div>
                        </div>
                    </div>
                </div>
